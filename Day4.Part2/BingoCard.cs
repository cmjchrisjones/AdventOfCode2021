...
class BingoCard
{
    ...
    internal bool PlayNumber(int playedNumber)
    {
        bool hasLineOrColumn = false;
        ...
        return hasLineOrColumn;
    }

    public void CalculateWinningScore(List<Line> lines, int winningNumber)
    {
